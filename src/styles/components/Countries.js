...
//"https://restcountries.eu/rest/v2/all?fields=name;population;region;capital;flag"
    ...
    return (
        ...
        <div className="sort-container">
            ...
            <ul>
                {radios.map((radio) => {
                    return (
                        <li key={radio}>
                            <input type="radio" value={radio} id={radio} checked={radio === setSelectedRadio} onChange={(e) => setSelectedRadio(e.target.value)} />
        ...
        {selectedRadio && <h5 onClick={() => setSelectedRadio("")}>Annuler la sélection</h5>}
